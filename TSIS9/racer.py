...
background = pygame.image.load(ASSET("materials", "AnimatedStreet.png"))
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(ASSET("materials", "Enemy.png"))
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(ASSET("materials", "Player.png"))
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        original_image = pygame.image.load(ASSET("materials", "Coin.png"))
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        crash_sound = pygame.mixer.Sound(ASSET("materials", "crash.wav"))
        crash_sound.play()
        time.sleep(0.5)
