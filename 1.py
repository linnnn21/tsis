...
bg = pygame.transform.scale(pygame.image.load("images/mainclock.png"), (500, 500))

left_arm = pygame.image.load("images/leftarm.png")   # секундная стрелка  
right_arm = pygame.image.load("images/rightarm.png")  # минутная
